...
function Board() {
  ...
  return (
    <div className="centerContent container" style={{background:"linear-gradient(to top, rgb(255 236 236), rgb(0 159 255 / 90%))"}}>
      ...
      <div>
        {[0,1,2].map((p,index)=>
                ...
                >
                  ...
                  >
                    <div style={{position:"absolute",top:"50%",left:"50%",transform:"translate(-50%,-50%)", color:board?.[t.row]?.[t.col] == 1 ? colors['player1']:colors['player2'], fontWeight:700, fontSize:"2rem"}}>
      ...
      } style={{display:'none'}} className="overlay">
